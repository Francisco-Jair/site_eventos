...
class Usuarios(models.Model):
    ...
    # Minicursos
    curso1 = models.BooleanField(default=False)
    curso2 = models.BooleanField(default=False)
    curso3 = models.BooleanField(default=False)
    curso4 = models.BooleanField(default=False)
    curso5 = models.BooleanField(default=False)
